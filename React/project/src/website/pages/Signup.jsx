                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-md-12 mb-3">
                             ...
                             <div className="form-group col-md-12 mb-3">
                                ...
                                <input type="password" className="form-control mt-1" id="email" name="password" placeholder="Password" />
                            </div>
                              <div className="form-group col-md-12 mb-3">
                                <label htmlFor="inputemail">Mobile</label>
                                <input type="number" className="form-control mt-1" id="email" name="mobile" placeholder="Mobile" />
                            </div>
                        </div>
